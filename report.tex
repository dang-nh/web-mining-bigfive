...
\midrule
\textbf{Hybrid (Co-occurrence)} & 0.088 & \textbf{0.451} & \textbf{0.278} & \textbf{Best}*. Rules capture strong priors. \\
Ensemble (RRF) & 0.128 & 0.377 & 0.202 & Diluted by lower-precision GNN scores. \\
\bottomrule
\end{tabular}
\\
\footnotesize{*Since PAN 2015 does not have a standard hashtag recommendation benchmark, we compare our method against standard baselines (Popularity, Content-based, LightGCN) implemented in the same setting.}
\end{table}
